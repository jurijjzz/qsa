...
// Gated Synch Stuff //////////////////////////////////////////////////////////
	{
		...
		AlpSynchGate.Polarity = 0;	// inverted polarity
		AlpSynchGate.Gate[0] = 0;	// but permanently inactive
		// this results in permanent high level

		VERIFY_ALP( AlpDevControlEx( AlpDevId, ALP_DEV_DYN_SYNCH_OUT3_GATE, &AlpSynchGate ) );
	}
